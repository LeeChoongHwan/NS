...
export default function EmployeeHome(){
    ...
    return (
        <>
            ...
            <Button className={"col-12 mt-3 mb-3"} lg variant={"info"} onClick={() => moveTo(nav_comp_list())}>사고목록조회</Button>
            <Button className={"col-12 mt-3 mb-3"} lg variant={"warning"} onClick={() => moveTo(nav_comp_investigate_list())}>손해조사</Button>
            <Button className={"col-12 mt-3 mb-3"} lg variant={"light"} onClick={() => moveTo(nav_comp_loss_assess_list())}>손해사정</Button>
