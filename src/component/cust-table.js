    ...
    return <>
        <Table striped bordered hover>
                ...
                })}
            {
                ...
                _modalProps.modalStatus === ModalMode.GUARANTEE ?
                    <GuaranteeModal _mode={_modalProps.mode} _show={_modalProps.showModal}
                                    _handleShow={_modalProps.setShowModal} _id={_modalProps.insId}/>
                    : <UwModal _show={_modalProps.showModal} _handleShow={_modalProps.setShowModal}
